...
type AuthClient interface {
	...
	IdentifyUser(ctx context.Context, in *IdentifyRequest, opts ...grpc.CallOption) (*IdentifyResponse, error)
}
...
func (c *authClient) IdentifyUser(ctx context.Context, in *IdentifyRequest, opts ...grpc.CallOption) (*IdentifyResponse, error) {
	out := new(IdentifyResponse)
	err := c.cc.Invoke(ctx, "/auth.Auth/IdentifyUser", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServer interface {
	...
	IdentifyUser(context.Context, *IdentifyRequest) (*IdentifyResponse, error)
...
func (UnimplementedAuthServer) IdentifyUser(context.Context, *IdentifyRequest) (*IdentifyResponse, error) {
...
func _Auth_IdentifyUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/auth.Auth/IdentifyUser",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
